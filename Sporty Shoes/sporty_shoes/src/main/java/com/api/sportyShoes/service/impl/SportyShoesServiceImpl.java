...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	@PostConstruct
	public void init() {
		Shoe s1 = new Shoe(1,"Shoe Name 01","Running",1000.24);
		Shoe s2 = new Shoe(2,"Shoe Name 02","Football",1100.24);
		Shoe s3 = new Shoe(3,"Shoe Name 03","Tennis",900.24);
		Shoe s4 = new Shoe(4,"Shoe Name 04","Basketball",1900.24);
		...
		Date d = new Date(0);
		PurchaseReport pr1 = new PurchaseReport(5,"user_1","Running",d,"adidas_runner:5,nike_Equipment:10");
		PurchaseReport pr2 = new PurchaseReport(6,"user_2","Fooball",d,"adidas_football:5,nike_studs:10");
		PurchaseReport pr3 = new PurchaseReport(7,"user_3","Tennis",d,"adidas_Tennis:5,nike_airmax:10");
		PurchaseReport pr4 = new PurchaseReport(8,"user_4","Basketball",d,"adidas_basketballl:5,nike_AirJordan1:10");
